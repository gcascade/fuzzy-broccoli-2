...
from tests.classes.character.stubs import stats


def test_character_initialization():
    character = Character("Hero", Novice(), "path", stats)
...
def test_reset_xp():
    character = Character("Hero", Novice(), "path", stats, xp=100)
    character.reset_xp()
    assert character.get_xp() == 0
...
def test_reset_level():
    character = Character("Hero", Novice(), "path", stats, level=5)
